...
import net.mcalec.mcalecsmod.init.McalecsmodModTabs;
...
@Mod("mcalecsmod")
public class McalecsmodMod {
	public static final Logger LOGGER = LogManager.getLogger(McalecsmodMod.class);
	public static final String MODID = "mcalecsmod";

	public McalecsmodMod() {
		MinecraftForge.EVENT_BUS.register(this);
		IEventBus bus = FMLJavaModLoadingContext.get().getModEventBus();
		McalecsmodModSounds.REGISTRY.register(bus);
		McalecsmodModBlocks.REGISTRY.register(bus);
		McalecsmodModBlockEntities.REGISTRY.register(bus);
		McalecsmodModItems.REGISTRY.register(bus);
