...
import net.mcalec.mcalecsmod.procedures.MusicUIkeybindOnKeyReleasedProcedure;
...
public class MusicUIkeybindMessage {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		McalecsmodMod.addNetworkMessage(MusicUIkeybindMessage.class, MusicUIkeybindMessage::buffer, MusicUIkeybindMessage::new, MusicUIkeybindMessage::handler);
	}
}
