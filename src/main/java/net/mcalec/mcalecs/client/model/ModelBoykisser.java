...
public class ModelBoykisser<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("mcalecs", "model_boykisser"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition TailBaseLayer_r1 = TailBase.addOrReplaceChild("TailBaseLayer_r1",
				CubeListBuilder.create().texOffs(0, 73).addBox(-1.0F, 10.5F, -2.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.25F)).texOffs(0, 64).addBox(-1.0F, 10.5F, -2.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition TailEndLayer_r1 = TailEnd.addOrReplaceChild("TailEndLayer_r1",
				CubeListBuilder.create().texOffs(18, 73).addBox(-1.0F, 11.25F, -2.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.25F)).texOffs(18, 64).addBox(-1.0F, 11.25F, -2.0F, 2.0F, 2.0F, 7.0F, new CubeDeformation(0.0F)),
